...
nvcc -g -G -o main main.cu tasks/task.cu schedulers/schedulerBase/scheduler.cu schedulers/JLFPScheduler/JLFP.cu schedulers/dumbScheduler/dumbScheduler.cu \
  ...
  jobs/jobLaunchInformation/printJobLaunchInformation.cu jobs/jobLaunchInformation/busyJobLaunchInformation.cu \
  jobs/kernels/printKernel.cu jobs/jobBase/job.cu jobs/printJob/printJob.cu jobs/busyJob/busyJob.cu jobs/vectorAddJob/vectorAddJob.cu \
